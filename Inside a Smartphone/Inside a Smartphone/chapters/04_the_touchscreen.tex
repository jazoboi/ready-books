...
\begin{newwords}
  \begin{description}[labelwidth=4.2cm, leftmargin=4.4cm]
    \item[\term{Capacitive touchscreen}] A screen that detects where your finger changes its invisible electrical field.
    \item[\term{Gesture}]               A finger movement that sends a command.
    \item[\term{Pixel}]                 A tiny dot of colour on a screen.
    \item[\term{Screen resolution}]     The number of pixels on a screen.
  \end{description}
\end{newwords}
