...
% --- Recap checkpoint (added per review: reduce cognitive density) ---
\begin{tcolorbox}[enhanced,colback=SunYellow!12,colframe=SunYellow!70!black,arc=6pt,boxrule=1pt,
  fonttitle=\bfseries\large, title={\faRetweet\quad Remember So Far}]
  \begin{itemize}
    \item The \textbf{internet} is a giant network of connected devices (Chapter~1).
    \item \textbf{Browsers} take us to websites, which are stored somewhere on the internet (Chapter~2).
    \item \textbf{Wi-Fi} and \textbf{routers} get your request out of your home (Chapter~3).
    \item Now you have arrived at the \textbf{server} — the powerful computer that stores the website you asked for!
  \end{itemize}
\end{tcolorbox}
