...
\begin{tcolorbox}[enhanced,colback=SunYellow!12,colframe=SunYellow!70!black,arc=6pt,boxrule=1pt,
  ...
  \begin{itemize}
    \item Your request has already travelled from your device through \textbf{Wi-Fi}, past the \textbf{router}, to your ISP, and reached a \textbf{server} in a data centre.
    \item But what if the server is in a completely different country, across an ocean?
    \item That is where \textbf{undersea cables} come in — the secret highways under the sea!
  \end{itemize}
\end{tcolorbox}
