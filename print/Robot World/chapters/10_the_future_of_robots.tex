...
\begin{tcolorbox}[enhanced,colback=SunYellow!12,colframe=SunYellow!70!black,arc=6pt,boxrule=1pt,
  fonttitle=\bfseries\large, title={\faRetweet\quad Remember from Books 1 \& 2}]
  \begin{itemize}
    \item In Book~1, you learned how data travels through the \textbf{internet} — over Wi-Fi, through cables, and across oceans.
    \item In Book~2, you met the \textbf{sensors} inside a smartphone: the camera, GPS, gyroscope, and accelerometer.
    \item Robots use all of these things! They connect over the internet, and their sensors are close cousins of smartphone sensors.
  \end{itemize}
\end{tcolorbox}
...
% --- Guided reflection (added per review: scaffold ethics discussion) ---
\begin{tcolorbox}[enhanced,colback=RoboGreen!8,colframe=RoboGreen!70!black,arc=6pt,boxrule=1pt,
  fonttitle=\bfseries\large, title={\faComments\quad Think and Talk}]
  Talk about these with a friend, parent, or teacher:
  \begin{enumerate}[label=\textbf{\arabic*.}]
    \item A companion robot learns what makes you happy and sad.
          Who else might see that information? Would you want them to?
    \item A delivery drone flies over your garden every day.
          How would that feel? What rules should drones follow?
    \item A robot can write stories and draw pictures.
          Is a picture ``made by you'' if a robot did the drawing?
  \end{enumerate}
  \emph{There are no wrong answers --- the important thing is to think carefully and listen to others.}
\end{tcolorbox}
