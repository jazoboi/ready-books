---
title: "The Secret Life of the Internet"
...
![How information starts its journey from your home to the world.](assets/diagrams/how-information-starts-its-journey-from-your-home-.png)
...
![What happens in a flash when you press Enter.](assets/diagrams/what-happens-in-a-flash-when-you-press-enter.png)
...
![A home network with one router connecting many devices.](assets/diagrams/a-home-network-with-one-router-connecting-many-dev.png)
...
![Request and response travelling between you and a distant server.](assets/diagrams/request-and-response-travelling-between-you-and-a-.png)
...
![Cross-section of an undersea cable and its protective layers.](assets/diagrams/cross-section-of-an-undersea-cable-and-its-protect.png)
...
![Packets split apart, travel along different routes, and reassemble.](assets/diagrams/packets-split-apart-travel-along-different-routes-.png)
...
![From crawling pages to ranking the best results.](assets/diagrams/from-crawling-pages-to-ranking-the-best-results.png)
...
![Devices connect through the internet to cloud servers and data centres.](assets/diagrams/devices-connect-through-the-internet-to-cloud-serv.png)
...
![Your six safety tools, all on one explorer’s shield.](assets/diagrams/your-six-safety-tools-all-on-one-explorer-s-shield.png)
